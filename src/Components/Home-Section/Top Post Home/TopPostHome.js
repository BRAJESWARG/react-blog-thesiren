    ...
    return (
        <div>
            ...
            <div>
                ...
                {blog.filter((value) => value.ID === '1' && value.Category === "Bollywood").map((val) => (
                    <div>
                ...
                {blog.filter((value) => ((value.ID === '2' && value.Category === "Technology") || (value.ID === '3' && value.Category === "Hollywood") ||  (value.ID === '4' && value.Category === "Food"))).map((val) => (
                    <div>
                        <Link to={`/article/${val.Category}/${val.ID}`}>
